...
import { makeIsUserCredentialsValidQuery } from "./is-user-credentials-valid"
...
describe ("authenticate-user", () => {
    ...
    let user: User
    let cmd: ReturnType<typeof makeIsUserCredentialsValidQuery>
    ...
    beforeAll(async () => {
        ...
        cmd = makeIsUserCredentialsValidQuery(logger, userRepository)
